...
/**
 * Componente encargado de la visualización y administración
 * del listado general de reservas del sistema.
 *
 * Funcionalidades principales:
 * - Consultar reservas registradas
 * - Mostrar información de clientes y habitaciones
